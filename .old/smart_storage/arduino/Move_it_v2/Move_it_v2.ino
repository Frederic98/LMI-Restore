...
void setup() {
  ...
  stepperX.setMaxSpeed(325);   //1000
  stepperX.setAcceleration(100); //200
  stepperY.setMaxSpeed(200); //1000
  stepperY.setAcceleration(100); //50
  stepperZ.setMaxSpeed(1200);  //3000
...
void loop() {
  ...
  case 3:               // "Set" state (Place box)
    ...
    ConvertToSteps();     // Calculate the position of the container
    MoveToGoalXY();       // Move to the container
    PlaceContainer();      // Grab the container
